...
line. Click the first point to close the route. Press `P` again after closing a
route to start a new one, or right-click to cancel the route being created. An
